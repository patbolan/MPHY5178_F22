...
KK(1,:) = deltaT .* dM_dt_function(B1x, B1y, R1, R2, Omega, Minit);
KK(2,:) = deltaT .* dM_dt_function(B1x, B1y, R1, R2, Omega, Minit + KK(1,:)./2);
KK(3,:) = deltaT .* dM_dt_function(B1x, B1y, R1, R2, Omega, Minit + KK(2,:)./2);
KK(4,:) = deltaT .* dM_dt_function(B1x, B1y, R1, R2, Omega, Minit + KK(3,:));
...
% and relaxation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function dMdt = dM_dt_function(b1x, b1y, R1, R2, Omega, M)
